...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    heroImage: "/products/luminora/hero-v2.webp",
    heroLabel: "صورة المنتج",
    rating: 4.9,
    reviewCount: 174,
    problemTag: "تجاعيد",
    dailyOrders: 13,
    gallery: [
      { src: "/products/luminora/hero-v2.webp", label: "1 · قبل وبعد" },
      { src: "/products/luminora/1-v2.webp", label: "2 · المشكلة" },
      { src: "/products/luminora/2-v2.webp", label: "3 · النتيجة" },
    ...
    reviews: [
      { name: "إيناس", city: "الرباط", text: "الجبين كان كيبان فالضو، والهالات حتى فنهار الراحة. من بعد شهر حسّيت الوجه أكثر تماسكاً، الخطوط أخف.", stars: 5, photo: "/products/luminora/reviews/1-v2.webp" },
      { name: "سناء", city: "الدار البيضاء", text: "خدمة وسهر، والكونسيلر ما عادش كيكفي تحت العين. الكبسولة ولات مع الفطور. الهالات ولاّت أهدى.", stars: 5, photo: "/products/luminora/reviews/2-v2.webp" },
      { name: "غيثة", city: "مراكش", text: "ما بقاش إحساس أن الخد رخا. التماسك رجع شوية شوية، بلا وعود خرافية.", stars: 5, photo: "/products/luminora/reviews/3-v2.webp" },
      { name: "وفاء", city: "طنجة", text: "ما حسيتش بجوع ولا غثيان. ساهلة. الخطوط حول العين ولاّت أقل وضوح.", stars: 4, photo: "/products/luminora/reviews/4-v2.webp" },
      { name: "رجاء", city: "أكادير", text: "كنت كنخبي الزاوية فالتيليفون بسبب الهالات. دابا كنصوّر عادي أكثر.", stars: 5, photo: "/products/luminora/reviews/5-v2.webp" },
    ],
    comparison: [
    ...
    sections: [
      {
        ...
        imageLabel: "صورة المشكلة",
        image: "/products/luminora/1-v2.webp",
      },
      {
      ...
      },
      {
        ...
        image: "/products/luminora/2-v2.webp",
      },
    ],
  },
];
