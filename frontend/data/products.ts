...
export const PROBLEM_ZONES = [
  {
    ...
    feeling:
      "كتزيدي طبقة فوندو وكتبدّلي الزاوية فالضو، ولكن البقعة كتبقى باينة. بغيتي ترتاحي قدام المرآة بلا ما تثقلي وجهك بالمكياج.",
  },
  {
    id: "femme",
...
export const PRODUCTS: Product[] = [
  {
    ...
    feelingTitle: "الكلف ما كيتغطّاش بالفوندو",
    ...
    heroQuote: "الكلف ما كيتغطّاش بالفوندو. خاصو روتين ثابت، واقي شمس، وشوية ديال الصبر.",
    ...
    reviews: [
      ...
      { name: "إيمان", city: "مراكش", text: "كنت كنحاول نغطي البقع بالفوندو. دابا كنكتفي بمكياج خفيف وكنحس براسي مرتاحة أكثر.", stars: 5, photo: "/products/clarelia/reviews/2.png" },
    ...
    sections: [
      {
        ...
        body: "فالتصويرة والضو الطبيعي، البقعة كتبقى باينة مهما زدتي من الفوندو. الهدف هو ترجعي مرتاحة بوجه أخف ومظهر أكثر تجانساً.",
...
export const HOME_REVIEWS = [
  { name: "سارة", city: "الدار البيضاء", text: "كنت كنغطي الكلف بالفوندو حتى فالدار. ما تبدّلش فسبوع، ولكن من بعد شهر حسّيت وجهي أكثر تجانساً فالضو.", stars: 5, product: "كلف" },
