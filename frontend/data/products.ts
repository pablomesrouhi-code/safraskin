...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    reviews: [
      { name: "إيناس", city: "الرباط", text: "الجبين كان كيبان فالضو، والهالات حتى فنهار الراحة. من بعد شهر حسّيت الوجه أكثر تماسكاً، الخطوط أخف.", stars: 5, photo: "/products/luminora/reviews/1-v3.webp" },
      { name: "سناء", city: "الدار البيضاء", text: "خدمة وسهر، والكونسيلر ما عادش كيكفي تحت العين. الكبسولة ولات مع الفطور. الهالات ولاّت أهدى.", stars: 5, photo: "/products/luminora/reviews/2-v3.webp" },
      { name: "غيثة", city: "مراكش", text: "ما بقاش إحساس أن الخد رخا. التماسك رجع شوية شوية، بلا وعود خرافية.", stars: 5, photo: "/products/luminora/reviews/3-v3.webp" },
      { name: "وفاء", city: "طنجة", text: "ما حسيتش بجوع ولا غثيان. ساهلة. الخطوط حول العين ولاّت أقل وضوح.", stars: 4, photo: "/products/luminora/reviews/4-v3.webp" },
      { name: "رجاء", city: "أكادير", text: "كنت كنخبي الزاوية فالتيليفون بسبب الهالات. دابا كنصوّر عادي أكثر.", stars: 5, photo: "/products/luminora/reviews/5-v3.webp" },
    ],
    comparison: [
