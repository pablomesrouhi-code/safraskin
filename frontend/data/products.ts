...
export const PRODUCTS: Product[] = [
  {
    ...
    image: "/products/_cutouts/clarelia.png",
    heroImage: "/products/clarelia/hero.jpg",
    ...
    dailyOrders: 14,
    gallery: [
      { src: "/products/clarelia/hero.jpg", label: "1 · قبل وبعد" },
      { src: "/products/clarelia/1.jpg", label: "2 · المشكلة" },
      { src: "/products/clarelia/2.jpg", label: "3 · النتيجة" },
      { src: "/products/clarelia/3.jpg", label: "4 · المنتج" },
    ],
    ingredients: [
    ...
    reviews: [
      { name: "سارة", city: "الدار البيضاء", text: "كلف الصيف كان باين بزاف. ما تبدّلش فسبوع، ولكن من بعد شهر حسّيت لون وجهي ولا أكثر تجانساً.", stars: 5, photo: "/products/clarelia/reviews/1.png" },
      { name: "إيمان", city: "مراكش", text: "كنت كنحاول نغطي البقع بالفوندوتان. دابا كنكتفي بمكياج خفيف وكنحس براسي مرتاحة أكثر.", stars: 5, photo: "/products/clarelia/reviews/2.png" },
  ...
  },
  {
    ...
    image: "/products/_cutouts/femmelia.png",
    heroImage: "/products/femmelia/hero.jpg",
    heroLabel: "صورة المنتج",
    rating: 4.7,
    reviewCount: 142,
    problemTag: "أنوثة",
    dailyOrders: 11,
    gallery: [
      { src: "/products/femmelia/hero.jpg", label: "1 · قبل وبعد" },
      { src: "/products/femmelia/1.jpg", label: "2 · المشكلة" },
      { src: "/products/femmelia/2.jpg", label: "3 · النتيجة" },
      { src: "/products/femmelia/3.jpg", label: "4 · المنتج" },
    ],
    ingredients: [
  ...
  },
  {
    ...
    upsellAffinity: "luminora",
    image: "/products/_cutouts/capilys.png",
    heroImage: "/products/capilys/hero.jpg",
    heroLabel: "صورة المنتج",
    rating: 4.8,
    reviewCount: 209,
    problemTag: "شعر",
    dailyOrders: 16,
    gallery: [
      { src: "/products/capilys/hero.jpg", label: "1 · قبل وبعد" },
      { src: "/products/capilys/1.jpg", label: "2 · المشكلة" },
      { src: "/products/capilys/2.jpg", label: "3 · النتيجة" },
      { src: "/products/capilys/3.jpg", label: "4 · المنتج" },
    ],
    ingredients: [
  ...
  },
  {
    ...
    upsellAffinity: "clarelia",
    image: "/products/_cutouts/luminora.png",
    heroImage: "/products/luminora/hero.jpg",
    heroLabel: "صورة المنتج",
    rating: 4.9,
    reviewCount: 174,
    problemTag: "إشراق",
    dailyOrders: 13,
    gallery: [
      { src: "/products/luminora/hero.jpg", label: "1 · قبل وبعد" },
      { src: "/products/luminora/1.jpg", label: "2 · المشكلة" },
      { src: "/products/luminora/2.jpg", label: "3 · النتيجة" },
      { src: "/products/luminora/3.jpg", label: "4 · المنتج" },
    ],
    ingredients: [
    ...
    reviews: [
      ...
      { name: "سناء", city: "الدار البيضاء", text: "خدمة وسهر، والماسك ما بقاش كافي. الكبسولة ولات جزء من فطوري كل صباح.", stars: 5, photo: "/products/luminora/reviews/2.png" },
