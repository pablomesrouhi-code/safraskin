...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    heroImage: "/products/luminora/hero-v3.webp",
    heroLabel: "صورة المنتج",
    rating: 4.9,
    reviewCount: 174,
    problemTag: "تجاعيد",
    dailyOrders: 13,
    gallery: [
      { src: "/products/luminora/hero-v3.webp", label: "1 · قبل وبعد" },
      { src: "/products/luminora/1-v3.webp", label: "2 · المشكلة" },
    ...
    sections: [
      {
        ...
        imageLabel: "صورة المشكلة",
        image: "/products/luminora/1-v3.webp",
      },
      {
