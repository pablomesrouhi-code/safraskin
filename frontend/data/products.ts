...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    heroImage: "/products/femmelia/hero-v7.webp",
    heroLabel: "صورة المنتج",
    rating: 4.7,
    reviewCount: 142,
    problemTag: "أنوثة",
    dailyOrders: 11,
    gallery: [
      { src: "/products/femmelia/hero-v7.webp", label: "1 · قبل وبعد" },
      { src: "/products/femmelia/1-v4.webp", label: "2 · المشكلة" },
      { src: "/products/femmelia/2-v7.webp", label: "3 · النتيجة" },
    ...
    sections: [
      ...
      },
      {
        ...
        imageLabel: "صورة الإحساس",
        image: "/products/femmelia/2-v7.webp",
      },
    ],
  },
  {
