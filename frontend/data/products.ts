...
export const PROBLEM_ZONES = [
  ...
  },
  {
    ...
    name: "التجاعد والهالات",
    feeling:
      "الخطوط كيبانو فالجبين وحول العين، والهالات ما كيتغطيوش بالكونسيلر. بغيتي وجهك يرجع أكثر تماسكاً، شوية بشوية.",
  },
] as const;
...
export const PRODUCTS: Product[] = [
  {
    ...
    image: "/products/home/clarelia-1600.webp",
    heroImage: "/products/clarelia/hero-1600.webp",
    ...
    dailyOrders: 14,
    gallery: [
      { src: "/products/clarelia/hero-1600.webp", label: "1 · قبل وبعد" },
      { src: "/products/clarelia/1-1600.webp", label: "2 · المشكلة" },
      { src: "/products/clarelia/2-1600.webp", label: "3 · النتيجة" },
      { src: "/products/clarelia/3-1600.webp", label: "4 · المنتج" },
    ],
    ingredients: [
    ...
    reviews: [
      { name: "سارة", city: "الدار البيضاء", text: "كلف الصيف كان باين بزاف. ما تبدّلش فسبوع، ولكن من بعد شهر حسّيت لون وجهي ولا أكثر تجانساً.", stars: 5, photo: "/products/clarelia/reviews/1-1600.webp" },
      { name: "إيمان", city: "مراكش", text: "كنت كنحاول نغطي البقع بالفوندوتان. دابا كنكتفي بمكياج خفيف وكنحس براسي مرتاحة أكثر.", stars: 5, photo: "/products/clarelia/reviews/2-1600.webp" },
      { name: "ندى", city: "الرباط", text: "بعد الحمل بقات ليا بقع. الروتين ساهل وما فيهوش ريحة قوية.", stars: 5, photo: "/products/clarelia/reviews/3-1600.webp" },
      { name: "لبنى", city: "فاس", text: "ما بقاتش أول حاجة كنشوفها فالضو. هاد الشي اللي كنت باغاه.", stars: 5, photo: "/products/clarelia/reviews/4-1600.webp" },
      { name: "حنان", city: "طنجة", text: "كنت كنخبي الزاوية فالتيليفون. دابا كنصوّر عادي.", stars: 5, photo: "/products/clarelia/reviews/5-1600.webp" },
    ],
    comparison: [
    ...
    sections: [
      {
        ...
        image: "/products/clarelia/1-1600.webp",
      },
      {
        ...
        image: "/products/clarelia/3-1600.webp",
      },
      {
      ...
      },
      {
        ...
        image: "/products/clarelia/2-1600.webp",
      },
    ],
  },
  {
    ...
    image: "/products/home/femmelia-1600.webp",
    heroImage: "/products/femmelia/hero-v4.webp",
    heroLabel: "صورة المنتج",
    rating: 4.7,
    reviewCount: 142,
    problemTag: "أنوثة",
    dailyOrders: 11,
    gallery: [
      { src: "/products/femmelia/hero-v4.webp", label: "1 · قبل وبعد" },
      { src: "/products/femmelia/1-v4.webp", label: "2 · المشكلة" },
      { src: "/products/femmelia/2-v4.webp", label: "3 · النتيجة" },
      { src: "/products/femmelia/3-1600.webp", label: "4 · المنتج" },
    ],
    ingredients: [
    ...
    reviews: [
      { name: "مريم", city: "الدار البيضاء", text: "ما حسّيتش براسي سلعة. بقيت على الروتين بهدوء.", stars: 5, photo: "/products/femmelia/reviews/1-1600.webp" },
      { name: "أمينة", city: "أكادير", text: "كبسولة ساهلة. حسّيت براسي مهتمّة بأنوثتي بلا دراما.", stars: 5, photo: "/products/femmelia/reviews/2-1600.webp" },
      { name: "ياسمين", city: "سلا", text: "هاد الموضوع كان كيحرجني حتى مع راسي. دابا كملت بلا توتر.", stars: 5, photo: "/products/femmelia/reviews/3-1600.webp" },
      { name: "إكرام", city: "وجدة", text: "طلبت علبتين. من بعد أسابيع الإحساس ولا أوضح.", stars: 4, photo: "/products/femmelia/reviews/4-1600.webp" },
      { name: "خديجة", city: "مكناس", text: "ماشي معجزة، ولكن الإحساس ولا أهدى من بعد أسابيع.", stars: 5, photo: "/products/femmelia/reviews/5-1600.webp" },
    ],
    comparison: [
    ...
    sections: [
      {
        ...
        imageLabel: "صورة المشكلة",
        image: "/products/femmelia/1-v4.webp",
      },
      {
        ...
        imageLabel: "صورة التركيبة",
        image: "/products/femmelia/3-1600.webp",
      },
      {
  ...
  },
  {
    ...
    upsellAffinity: "luminora",
    image: "/products/home/capilys-1600.webp",
    heroImage: "/products/capilys/hero-1600.webp",
    heroLabel: "صورة المنتج",
    rating: 4.8,
    reviewCount: 209,
    problemTag: "شعر",
    dailyOrders: 16,
    gallery: [
      { src: "/products/capilys/hero-1600.webp", label: "1 · قبل وبعد" },
      { src: "/products/capilys/1-1600.webp", label: "2 · المشكلة" },
      { src: "/products/capilys/2-1600.webp", label: "3 · النتيجة" },
      { src: "/products/capilys/3-1600.webp", label: "4 · المنتج" },
    ],
    ingredients: [
    ...
    reviews: [
      { name: "فاطمة", city: "الدار البيضاء", text: "المغسل كان كيخوفني. من بعد شهر حسّيت التساقط قلّ، والشعر ولا أهدى.", stars: 5, photo: "/products/capilys/reviews/1-1600.webp" },
      { name: "سلمى", city: "تطوان", text: "بعد الولادة طاح لي بزاف. ما رجعش بحال الأول بسرعة، ولكن الكثافة بدات تبان.", stars: 5, photo: "/products/capilys/reviews/2-1600.webp" },
      { name: "هدى", city: "القنيطرة", text: "الريحة خفيفة والزيت على الفروة ساهل. هاد الشي اللي خلّاني نكمل.", stars: 5, photo: "/products/capilys/reviews/3-1600.webp" },
      { name: "نورة", city: "الجديدة", text: "طلبت 3 علب من اللولة. عرفت أن الشعر كياخد وقت.", stars: 5, photo: "/products/capilys/reviews/4-1600.webp" },
      { name: "أسماء", city: "فاس", text: "ما بقاتش كل مشطة كتخوفني بحال الأول.", stars: 5, photo: "/products/capilys/reviews/5-1600.webp" },
    ],
    comparison: [
    ...
    sections: [
      {
        ...
        imageLabel: "صورة المشكلة",
        image: "/products/capilys/1-1600.webp",
      },
      {
        ...
        imageLabel: "صورة التركيبة",
        image: "/products/capilys/3-1600.webp",
      },
      {
      ...
      },
      {
        ...
        image: "/products/capilys/2-1600.webp",
      },
    ],
  },
  {
    ...
    feelingTitle: "الخطوط والهالات كيبانو حتى فالمكياج",
    formulaLine: "كولاجين بحري · فيتامين C · زنك · عناصر دقيقة من الزعفران",
    labNote:
      "30 كبسولة كولاجين بحري. للعناية بمظهر التجاعيد والهالات من الداخل — كتكمل الكريم، ما كتعوّضوش.",
    problemTitle: "التجاعد والهالات",
    taglineAr: "كولاجين بحري مع فيتامين C والزنك، لعناية يومية بمظهر التماسك ونعومة الخطوط.",
    shortDescriptionAr: "كولاجين بحري 30 كبسولة · تجاعيد وهالات",
    heroQuote: "الخطوط والهالات ما كيتصلّحوش غير بالكريم من البرّا.",
    problemHook: "كتشوفي الخطوط فالجبين وحول العين، والهالات باقيين حتى من بعد الكونسيلر؟",
    problemBody:
      "مع الوقت والسهر، الوجه كيبدأ يفقد التماسك: خطوط، هالات، وإحساس أن البشرة رخات. الكريم من البرّا مهم، ولكن مظهر التجاعيد والهالات كيتغذّى من الداخل. لومينورا كبسولة مع الفطور، كل يوم.",
    mechanismTitle: "من الداخل كيدعم مظهر التماسك",
    mechanismBody:
      "الكولاجين البحري كيدعم مظهر النعومة والتماسك فالوجه. فيتامين C للبشرة اللي تحت الإجهاد. الزنك للروتين اليومي. كبسولة مع الفطور. العلبة 30 كبسولة. الفرق كيبان بالثبات، ماشي فسبوع.",
    unitPriceMad: TIER_PRICES[1],
    crossSellSlugs: ["clarelia", "capilys", "femmelia"],
    upsellAffinity: "clarelia",
    image: "/products/home/luminora-1600.webp",
    heroImage: "/products/luminora/hero-v4.webp",
    heroLabel: "صورة المنتج",
    rating: 4.9,
    reviewCount: 174,
    problemTag: "تجاعيد",
    dailyOrders: 13,
    gallery: [
      { src: "/products/luminora/hero-v4.webp", label: "1 · قبل وبعد" },
      { src: "/products/luminora/1-v4.webp", label: "2 · المشكلة" },
      { src: "/products/luminora/2-v3.webp", label: "3 · النتيجة" },
      { src: "/products/luminora/3-1600.webp", label: "4 · المنتج" },
    ],
    ingredients: [
      { name: "Marine collagen", nameAr: "كولاجين بحري", benefit: "كيدعم مظهر التماسك ونعومة الخطوط مع الالتزام اليومي." },
      { name: "Vitamin C", nameAr: "فيتامين C", benefit: "عناية بمظهر البشرة اللي تحت السهر والإجهاد، بما فيها منطقة العين." },
      { name: "Zinc", nameAr: "زنك", benefit: "يكمل الروتين اليومي للبشرة اللي خسّات تماسكها." },
    ...
    howToUse: [
      ...
      { step: 2, title: "كل يوم", body: "مظهر الخطوط والهالات كيتبدّل بالثبات، ماشي نهار وناقص نهار." },
      { step: 3, title: "مع الكريم", body: "الكولاجين من الداخل، والعناية الخارجية من البرّا. إلا كان الكلف جزء من القصة، كريم التفتيح كيكمل." },
    ],
    faqs: [
      { q: "واش هادشي دواء؟", a: "لا. مكمل غذائي للعناية بمظهر البشرة من الداخل، وما كيعالج حتى مرض. استشيري طبيبكِ فالحمل أو الأمراض المزمنة." },
      { q: "واش يمحّي التجاعيد؟", a: "لا. كيدعم مظهر التماسك ونعومة الخطوط والهالات مع الوقت. ما كاينش مسح فوري." },
      { q: "واش يغني على الكريم؟", a: "لا. كيكمل العناية الخارجية. التجاعيد والهالات من الداخل + الكريم اللي تحتاجيه من البرّا." },
      { q: "متى نحس بالفرق؟", a: "غالباً من 3 لـ 6 أسابيع على مستوى إحساس التماسك ومظهر الخطوط حول العين." },
    ],
    reviews: [
      { name: "إيناس", city: "الرباط", text: "الجبين كان كيبان فالضو، والهالات حتى فنهار الراحة. من بعد شهر حسّيت الوجه أكثر تماسكاً، الخطوط أخف.", stars: 5, photo: "/products/luminora/reviews/1-1600.webp" },
      { name: "سناء", city: "الدار البيضاء", text: "خدمة وسهر، والكونسيلر ما عادش كيكفي تحت العين. الكبسولة ولات مع الفطور. الهالات ولاّت أهدى.", stars: 5, photo: "/products/luminora/reviews/2-1600.webp" },
      { name: "غيثة", city: "مراكش", text: "ما بقاش إحساس أن الخد رخا. التماسك رجع شوية شوية، بلا وعود خرافية.", stars: 5, photo: "/products/luminora/reviews/3-1600.webp" },
      { name: "وفاء", city: "طنجة", text: "ما حسيتش بجوع ولا غثيان. ساهلة. الخطوط حول العين ولاّت أقل وضوح.", stars: 4, photo: "/products/luminora/reviews/4-1600.webp" },
      { name: "رجاء", city: "أكادير", text: "كنت كنخبي الزاوية فالتيليفون بسبب الهالات. دابا كنصوّر عادي أكثر.", stars: 5, photo: "/products/luminora/reviews/5-1600.webp" },
    ],
    comparison: [
      { title: "المشكل", generic: "كريم ليلي ووعد بالشباب", ours: "كولاجين يومي لمظهر الخطوط والهالات" },
      { title: "الوعد", generic: "وجه بحال 20 عام فسبوع", ours: "تماسك تدريجي وصدق فالكلام" },
      { title: "الالتزام", generic: "نهار نزيد نهار ننسى", ours: "جرعة يومية واضحة مع الفطور" },
    ],
    sections: [
      {
        title: "الخطوط والهالات ما كيتغطيوش",
        body: "الجبين كيهضر. تحت العين كيبان التعب. الكونسيلر كيثقل والخطوط كيبقاو. هادشي ما كيتصلّحش غير بالماسك.",
        imageLabel: "صورة المشكلة",
        image: "/products/luminora/1-v4.webp",
      },
      {
        title: "كولاجين للتماسك من الداخل",
        body: "كولاجين بحري لمظهر النعومة والتماسك. فيتامين C للبشرة المتعبة. زنك للروتين اليومي. 30 كبسولة — شهر مع الفطور.",
        imageLabel: "صورة التركيبة",
        image: "/products/luminora/3-1600.webp",
      },
      {
        title: "كبسولة مع الفطور",
        body: "كاس ماء، وخلاص. مظهر الخطوط والهالات كيتبدّل بالثبات، ماشي نهار وناقص نهار.",
        imageLabel: "صورة الروتين",
        image: "/products/luminora/3-1600.webp",
      },
      {
        title: "وجه أكثر تماسكاً، بنفس العمر",
        body: "الهدف ماشي وجه جديد. الهدف خطوط أخف، هالات أهدى، وإحساس أن البشرة واقفة شوية. إلا كان الكلف جزء من القصة، كريم التفتيح كيكمل من البرّا.",
        imageLabel: "صورة النتيجة",
        image: "/products/luminora/2-v3.webp",
      },
    ],
  },
];
...
export const HOME_REVIEWS = [
  ...
  { name: "إيناس", city: "الرباط", text: "الجبين كان كيبان فالضو، والهالات حتى فنهار الراحة. من بعد شهر حسّيت الوجه أكثر تماسكاً.", stars: 5, product: "تجاعيد" },
