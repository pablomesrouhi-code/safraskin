...
export const LAB_INTRO = {
  ...
  body: "التفتيح، التساقط، التجاعيد والهالات، أو المناطق الأنثوية: كل صيغة مكتوبة لإحساس واحد كتعرفيه. المختبر هنا هو الاختيار — شنو كيدخل العلبة، وشنو كيخرج منها.",
} as const;
