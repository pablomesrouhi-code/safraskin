...
export default function ProductHero({ product }: { product: Product }) {
  return (
    <section className="hero-glow border-b border-border">
      <div className="mx-auto grid max-w-container items-center gap-6 px-4 py-6 md:grid-cols-2 md:gap-10 md:py-12">
        <div className="order-1 relative aspect-[4/5] overflow-hidden rounded-3xl bg-white shadow-sm md:order-2 md:aspect-[4/5]">
          <ProductImage
        ...
        <div className="order-2 min-w-0 md:order-1">
          ...
          <p className="mt-3 text-sm leading-7 text-saffron-dark">
            {product.headlineAr}
