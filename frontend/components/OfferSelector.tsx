          ...
          return (
            ...
            >
              ...
              <div className="text-left shrink-0">
                {offer.badge && (
                  <span className="block bg-gold-light text-sage-dark text-xs font-semibold px-2 py-0.5 rounded-full mb-1">
                    {offer.badge}
                  </span>
                )}
                <span className="text-xl font-bold text-sage">{offer.price} ر.س</span>
              </div>
            </button>
          );
        })}
