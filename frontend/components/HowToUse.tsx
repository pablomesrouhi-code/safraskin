...
export default function HowToUse({ product }: { product: Product }) {
  return (
    <section className="mx-auto max-w-container px-4 py-14 md:py-16">
      ...
      <h2 className="mt-3 text-2xl font-bold">كيفاش تستعمليها</h2>
      <p className="mt-2 max-w-xl text-sm leading-7 text-muted">إيقاع ساهل، باش تكمّليه حتى تحسي بالفرق.</p>
